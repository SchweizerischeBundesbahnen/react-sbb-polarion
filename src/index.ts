...
export { DocsProvider, buildDocsConfig } from './docs/DocsContext';
export type { DocEntry, DocSearchRecord, DocsConfig, BuildDocsConfigOptions } from './docs/DocsContext';
// DocPage is the ready-made article page; DocLayout/DocArticle and the sidebar, breadcrumb, prev/next,
// on-this-page and search it composes are all internal - not part of the public API.
export { default as DocPage } from './components/documentation/DocPage';
export { default as DocLinkInterceptor } from './components/documentation/DocLinkInterceptor';
...
export { createAdminNav, docNodeForFeature } from './services/adminNav';
export type { AdminNav, AdminNavOptions, DocNodeForFeatureOptions } from './services/adminNav';
